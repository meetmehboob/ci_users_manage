...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="<?php echo base_url('assets/admi32n_ma4nager_con45trol_panel/');?>index.html"><img class="logo-img" src="<?php echo base_url('assets/admi32n_ma4nager_con45trol_panel/');?>assets/images/logo.png" alt="logo"></a><span class="splash-description">Admin Login Control Panel</span></div>
            <div class="card-body">
                ...
                <form method="post" action="">
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="login_id" name="login_id" type="text" placeholder="Login ID" autocomplete="off">
